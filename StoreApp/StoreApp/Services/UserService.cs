...
namespace UserService.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<IdentityUser> userManager, IConfiguration configuration, RoleManager<IdentityRole> roleManager, UserDbContext context, ILogger<UserService> logger)
        {
